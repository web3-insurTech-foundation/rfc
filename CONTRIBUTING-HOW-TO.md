...
We would love to accept your help to our project.
...
Visit <https://github.com/web3-insurTech-foundation/governance/blob/main/W3IF-Contributor%20Agreement%20(v1.1).pdf/> to see your current agreements or to sign a new one.


_NOTE:_ Commits and pull requests to W3IF repositories will only be accepted from those contributors with an active, executed Individual Contributor License Agreement (ICLA) with W3IF, _OR_ who are covered under an existing and active Corporate Contribution License Agreement (CCLA) executed with W3IF. Commits from individuals not covered under an ICLA or CCLA will be flagged and blocked by the [Linux Foundation EasyCLA tool](https://easycla.lfx.linuxfoundation.org/#/). Please note that some CCLAs require individuals/employees to be explicitly named on the CCLA.

_Need an ICLA? Unsure if you are covered under an existing CCLA? Email help@w3if.org._
...
### Pull Requests via GitHub (Quick Version)

1. Fork it (https://github.com/web3-insurTech-foundation/rfc)
...
* The W3IF Maintainers will apply the proper labels for the issue. This may include labels for priority, type, and metadata.
...
* ([https://github.com/web3-insurTech-foundation/rfc/fork](https://github.com/web3-insurTech-foundation/rfc/fork))
...
Contributions merged into the master branch of the RFC repository will form part of the next pre-draft of the RFC Standard (as defined by the Governance document), which must be approved by the Standard Working Group voting participants before it is accepted as a draft and subsequently released as the next version of the Standard.
